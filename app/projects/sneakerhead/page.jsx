  ...
  return (
    <div className="max-w-screen-3xl mx-auto relative h-screen bg-[#494848] ">
      <Image
        ...
        alt="/"
      />
      <div className="relative bg-black/80 max-w-screen-3xl h-full flex flex-col justify-center items-center gap-4">
      ...
      <div className="max-w-screen-3xl h-screen mx-auto px-4 py-4 sm:px-8 md:px-12 lg:px-20 xl:px-32 gap-18  xl:py-24">
        <div
          style={{ height: 1000 }}
