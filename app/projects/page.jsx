...
import secondGridPic from "../images/8.jpg"
import thirdGridPic from "../images/10.png"
import fourthGridPic from "../images/4.jpg"
import fifthGridPic from "../images/3.png"
import sixthGridPic from "../images/9.jpg"
  ...
  return (
    <div className="h-full px-4 py-4 max-w-[1920px] mx-auto lg:h-full sm:px-8">
      ...
      <div className=" grid md:grid-cols-2 xl:grid-cols-3 h-full gap-4">
        <ProjectItem title="Coffee Bar" backgroundImg={gridPic} projectUrl="/coffeebar" />
        <ProjectItem title="Furniture Web App" backgroundImg={secondGridPic} projectUrl="/coffeebar" />
        <ProjectItem title="Travel Website" backgroundImg={thirdGridPic} projectUrl="/coffeebar" />
        <ProjectItem title="Food App" backgroundImg={fourthGridPic} projectUrl="/coffeebar" />
        <ProjectItem title="Construction Website" backgroundImg={fifthGridPic} projectUrl="/coffeebar" />
        <ProjectItem title="Sneaker Head" backgroundImg={sixthGridPic} projectUrl="/coffeebar" />
