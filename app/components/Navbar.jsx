        ...
        <h2 className='text-4xl  h-full flex items-center justify-between px-4 py-4 sm:px-8 md:px-12 lg:px-20 xl:px-32 max-w-[1920px] mx-auto '>
          ...
          <div className='md:hidden'>
            ...
            <button className='w-10 h-8 flex flex-col justify-between z-50 relative' onClick={() => setOpen((prev) => !prev)}>
              ...
              <motion.div variants={centerVariants} animate={open ? "opened" : "closed"} className='w-10 h-1 bg-white rounded origin-left'></motion.div>
            ...
            {open && (
            <motion.div variants={listVariants} initial="closed" animate="opened" className='absolute top-0 left-0 w-screen h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-6xl text-transform: uppercase z-20'>
